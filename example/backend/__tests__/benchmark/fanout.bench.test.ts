...
describe("fanOut stress benchmarks", () => {
  ...
  test(`benchmark: ${STRESS.childCount} children dispatched and collected with no drops`, async () => {
  ...
  test("benchmark: mixed success/failure batches accounted with no cross-batch leakage", async () => {
  ...
  test(`benchmark: ${STRESS.concurrentFanOuts} concurrent fanOut calls don't lose dispatches`, async () => {
