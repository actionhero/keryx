...
describe("scaffoldProject", () => {
  test(
    "creates all default files with db and example (auth starter)",
    async () => {
      ...
      // Migration is dynamically generated by drizzle-kit — check for the pattern
      const migrationFile = files.find(
        (f) => f.startsWith("drizzle/") && f.endsWith("/migration.sql"),
      );
  ...
  test(
    "package.json has correct name and keryx dependency",
    async () => {
